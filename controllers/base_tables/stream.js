...
module.exports = {
  index: async(req,res) => {
    try {
      ...
      returnMessage.successMessage(res,messages.successMessages.getAllCountries,streams);
    } catch (error) {
  ...
  create: async (req, res) => {
    try {
      ...
      returnMessage.successMessage(res,messages.successMessages.addCountry,stream);
    } catch (error) {
      returnMessage.errorMessage(res,error);
    }
  },
  edit: async(req,res) => {
    try {
      ...
      returnMessage.successMessage(res,messages.successMessages.showCountry, stream);
    } catch(error) {
      returnMessage.errorMessage(res,error);
    }
  },
  update: async(req,res) => {
    try {
      const stream = await streamModel.findByIdAndUpdate(req.params['id'], { ...req.body });
      returnMessage.successMessage(res,messages.successMessages.updateCountry, stream);
    } catch (error) {
      returnMessage.errorMessage(res,error);
    }
  },
