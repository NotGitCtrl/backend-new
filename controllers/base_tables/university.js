...
module.exports = {
  index: async(req,res) => {
    try {
      ...
      returnMessage.successMessage(res,messages.successMessages.getAllCountries,universities);
    } catch (error) {
  ...
  create: async (req, res) => {
    try {
      ...
      returnMessage.successMessage(res,messages.successMessages.addCountry,university);
    } catch (error) {
      returnMessage.errorMessage(res,error);
    }
  },
  edit: async(req,res) => {
    try {
      ...
      returnMessage.successMessage(res,messages.successMessages.showCountry, university);
    } catch(error) {
      returnMessage.errorMessage(res,error);
    }
  },
  update: async(req,res) => {
    try {
      const university = await universityModel.findByIdAndUpdate(req.params['id'], { ...req.body });
      returnMessage.successMessage(res,messages.successMessages.updateCountry, university);
    } catch (error) {
      returnMessage.errorMessage(res,error);
    }
  },
